...
exports.userRepository = {
    list: () => __awaiter(void 0, void 0, void 0, function* () {
        return new Promise((resolve) => {
            try {
                services_1.Database.pool().query(userQueries_1.userQueries.LIST, (error, rows) => {
                    if (error)
    ...
    updatePassword: (id, psw) => __awaiter(void 0, void 0, void 0, function* () {
        return new Promise((resolve) => {
            try {
                ...
                const updateQuery = (0, mysql_1.format)(userQueries_1.userQueries.UPDATE_PASSWORD, [salt, id, password, id]);
                services_1.Database.pool().query(updateQuery, (error) => {
                    if (error)
                        throw new Error(error.message);
